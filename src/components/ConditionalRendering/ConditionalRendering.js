    ...
    return(
      <div className={"ConditionalRendering"}>
        ...
        <div className={"counter-visible"}>
          <button onClick={()=>this.setState({counterVisible: !this.state.counterVisible})}>Visible Of Counter</button>
        </div>
        {this.state.counterVisible && <Counter/>}
        <div className={"like"} onClick={()=>{this.setState((state)=>({visibleImg: !state.visibleImg}))}}>
